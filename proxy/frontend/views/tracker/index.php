...
<div class="page-header clearfix">
    ...
    <div class="pull-right">
        <?php $this->widget('bootstrap.widgets.TbButton', array(
                'label'=>Yii::t('labels', 'New tracker'),
                'type'=>'primary',
...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
	...
	'columns'=>array(
        'id',
		    'id_localization_tag',
        'localizationSystemType' => array(
            'header' => Yii::t('labels', 'Tracker type'),
            'name' => 'idLocalizationSystem',
            'type' => 'raw',
            'value' => function ($data, $raw, $column) {
              return $data->idLocalizationSystem->idType->type;
            },
