...
public class Place {
    ...
    */
    ...
    @XmlElement
    String getGeometry() {
        return Constants.GEO_JSON_POINT + lon + "," + lat + "," + level + Constants.GEO_JSON_TAIL;
    }

    public Place() {
    }

    public Place(Double lon, Double lat, Double level, String name) {
        this.lon = lon;
        this.lat = lat;
        this.name = name;
        this.level = level;
    ...
    public Place(Double lon, Double lat, Double level, String name, Calendar arrival, Calendar departure) {
        this(lon, lat, level, name);
