...
final public class TemporaryPartialStreetEdge extends PartialStreetEdge implements TemporaryEdge {
    ...
    public TemporaryPartialStreetEdge(StreetEdge parentEdge, TemporaryIndoorLocation v1,
    		TemporaryIndoorLocation v2, LineString geometry, String name, double length) {
        super(parentEdge, v1, v2, geometry, name, length);
    ...
    public TemporaryPartialStreetEdge(IndoorEdge parentEdge, TemporaryIndoorLocation v1,
    		TemporaryIndoorLocation v2, LineString geometry, String name, double length) {
        super(parentEdge, v1, v2, geometry, name, length);
    ...
    public TemporaryPartialStreetEdge(StreetEdge parentEdge, TemporaryStreetLocation v1,
            Vertex v2, LineString geometry, String name, double length) {
        super(parentEdge, v1, v2, geometry, name, length);
    ...
    public TemporaryPartialStreetEdge(StreetEdge parentEdge, Vertex v1,
            TemporaryStreetLocation v2, LineString geometry, String name, double length) {
        super(parentEdge, v1, v2, geometry, name, length);
    ...
    public TemporaryPartialStreetEdge(IndoorEdge parentEdge, TemporaryStreetLocation v1,
            TemporaryStreetLocation v2, LineString geometry, String name, double length) {
        super(parentEdge, v1, v2, geometry, name, length);
    ...
    public TemporaryPartialStreetEdge(IndoorEdge parentEdge, Vertex v1,
            TemporaryStreetLocation v2, LineString geometry, String name, double length) {
        super(parentEdge, v1, v2, geometry, name, length);
