...
public class PartialStreetEdge extends StreetWithElevationEdge {
	...
	public PartialStreetEdge(StreetEdge parentEdge, Vertex v1, Vertex v2,
	...
	public PartialStreetEdge(IndoorEdge parentEdge, Vertex v1, Vertex v2,
			LineString geometry, String name, double length) {
	 ...
	 */
	 ...
	 public int getInAngle() {
		 if(parentEdge instanceof IndoorEdge)
			 return ((IndoorEdge)parentEdge).getInAngle();
		 else return ((StreetEdge)parentEdge).getInAngle();
	 }
	 ...
	 public int getOutAngle() {
		 if(parentEdge instanceof IndoorEdge)
			 return ((IndoorEdge)parentEdge).getOutAngle();
		 else return ((StreetEdge)parentEdge).getOutAngle();
	 }
