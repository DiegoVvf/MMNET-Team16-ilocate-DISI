...
final public class TemporaryIndoorLocation extends IndoorLocation implements TemporaryVertex {
    /**
	 * 
	 */
	private static final long serialVersionUID = 8294789912404821282L;
	final private boolean endVertex;

    public TemporaryIndoorLocation(String id, Coordinate nearestPoint, String name,
                                   boolean endVertex, double level) {
        super(id, nearestPoint, name, level);
